...
public class SysConfig extends AbstractConfig {
	...
	public SysConfig(String myRootDir) {
		...
		doSetValue(SysConfig.DB_CONNECTION, "jdbc:postgresql://localhost:5432/weilbrenner");
		doSetValue(SysConfig.DB_USER, "weilbrenner");
		doSetValue(SysConfig.DB_PASSWORD, "F2tv7Pu80iZagJ89");
	}
